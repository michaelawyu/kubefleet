...
.PHONY: crd-verify
## Verify the chart CRD directories cover every CRD in config/crd/bases
## Note (chenyu1): kubefleet.dev CRDs are ignored for now until the implementation is completed.
crd-verify:
