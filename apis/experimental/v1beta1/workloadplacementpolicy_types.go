...
// WorkloadPlacementPolicy is a KubeFleet API that allows users to fine-tune how workloads
// are placed across member clusters from different multi-cluster node pools.
//
// +genclient
...
type WorkloadPlacementPolicy struct {
	...
	// Spec is the specification of the workload placement policy.
