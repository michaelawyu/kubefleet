...
func TestNodeTrackerAddOrUpdateSKUAndTotalAllocatableCapacity(t *testing.T) {
	testCases := []struct {
		name   string
		nt     *NodeTracker
		nodes  []*corev1.Node
...
// TestNodeMetricsAddOrUpdate tests the AddOrUpdate method of the node metrics tracker.
func TestNodeMetricsAddOrUpdate(t *testing.T) {
